...
- `src/parse/` Docling stage. `src/extract/` LLM extraction + verifier. `src/api/` FastAPI backend. `src/stats/` meta-analysis + validation. `pipelines/` + `tools/sepsis_atlas/` OpenWebUI surface.
